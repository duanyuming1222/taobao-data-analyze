...
public class ChartController {
    ...
    public ResultVO getEchartsList() {
        List<EchartsVo> chartVOList = echartsService.getEchartsList();
        ResultVO resultVO = new ResultVO(0, "success", chartVOList);
        return resultVO;
    }

    @GetMapping("/getClickUsers")
    public ResultVO getClickUsers() {
        List<UserRetentionVo> clickUsers = echartsService.getClickUsers();
        ResultVO resultVO = new ResultVO(0, "success", clickUsers);
        return resultVO;
    }

    @GetMapping("/getDirectBuyUsers")
    public ResultVO getDirectBuyUsers() {
        List<UserRetentionVo> directBuyUsers = echartsService.getDirectBuyUsers();
        ResultVO resultVO = new ResultVO(0, "success", directBuyUsers);
        return resultVO;
    }
    @GetMapping("/getFavBuyUsers")
    public ResultVO getFavBuyUsers() {
        List<UserRetentionVo> directBuyUsers = echartsService.getFavBuyUsers();
        ResultVO resultVO = new ResultVO(0, "success", directBuyUsers);
        return resultVO;
    }

    @GetMapping("/getCartBuyUsers")
    public ResultVO getCartBuyUsers() {
        List<UserRetentionVo> directBuyUsers = echartsService.getCartBuyUsers();
        ResultVO resultVO = new ResultVO(0, "success", directBuyUsers);
        return resultVO;
    }
    @GetMapping("/getBothBuyUsers")
    public ResultVO getBothBuyUsers() {
        List<UserRetentionVo> directBuyUsers = echartsService.getBothBuyUsers();
        ResultVO resultVO = new ResultVO(0, "success", directBuyUsers);
        return resultVO;
    }
    @GetMapping("/getUserBehaviorHour")
    public ResultVO getUserBehaviorHour() {
        List<UserBehaviorHourVo> userBehaviorHourVos = echartsService.getUserBehaviorHour();
        ResultVO resultVO = new ResultVO(0, "success", userBehaviorHourVos);
        return resultVO;
    }
