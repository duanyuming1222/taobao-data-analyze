    ...
    children: [
      {
        path: 'index',
        name: 'top',
        component: () => import('@/views/echart/top.vue'),
        meta: {
          title: '热度分析',
          icon: 'chart-line',
          roles: ['admin', 'manager', 'staff']
      ...
      },
      {
        path: 'userRetention',
        name: 'userRetention',
        component: () => import('@/views/echart/userRetention.vue'),
        meta: {
          title: '用户留存分析',
          icon: 'chart-line',
          roles: ['admin', 'manager', 'staff']
      ...
      {
        path: 'userBehaviorHour',
        name: 'userBehaviorHour',
        component: () => import('@/views/echart/userBehaviorHour.vue'),
        meta: {
          title: '用户行为分析(按小时)',
          icon: 'chart-line',
          roles: ['admin', 'manager', 'staff']
